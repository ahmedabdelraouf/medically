            ...
            <div class="iq-card">
                <div class="iq-card-body">
                    ...
                    <div class="new-user-info">
                        {!! Form::open(['method'=>'put' , 'route'=>['user.profile.update'  ,auth()->user()->id] ,'enctype'=>'multipart/form-data'  , 'id'=>'edit-admin-form']) !!}
                        <div class="row">
                            @method('PUT')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                {!! Form::select('gender' ,['male'=>trans('admin.male') , 'female'=>trans('admin.female')], old('gender') ?? auth()->user()->gender ,['class'=>'form-control' ,'required'=>'required', 'id'=>'gender' , 'placeholder'=>trans('admin.gender')]) !!}
                            </div>
                            <div class="form-group col-md-6">
