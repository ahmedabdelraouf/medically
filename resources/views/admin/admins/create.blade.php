...
@section('title', trans('admin.add-admin'))
    ...
    <div class="row">
            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title"> {{trans('admin.add-admin')}} </h4>
                    </div>
                </div>
            </div>
            <div class="iq-card">
                        ...
                        <div class="form-group text-center">
                            <div class="add-img-user profile-img-edit">
                                ...
                                <div class="p-image">
                                    ...
                                    <input name="image" class="file-upload" form="add-admin-form" type="file" accept="image/*">
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-lg-9">
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title"> {{trans('admin.admin-info')}}</h4>
                    </div>
                </div>
                <div class="iq-card-body">
                    @include('admin.include.messages_errors')
                    <div class="new-user-info">
                        {!! Form::open(['method'=>'post' , 'route'=>['admins.store' ] ,'enctype'=>'multipart/form-data'  , 'id'=>'add-admin-form']) !!}
                        <div class="row">
                            @method('POST')
