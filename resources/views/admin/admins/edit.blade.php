...
@section('title', trans('admin.edit-admin'))
            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title"> {{trans('admin.edit-admin')}} </h4>
                    </div>
                </div>
            </div>
            <div class="iq-card">
            ...
            <div class="iq-card">
                ...
                <div class="iq-card-body">
                    ...
                    <div class="new-user-info">
                        {!! Form::open(['method'=>'put' , 'route'=>['admins.update' , $user->id] ,'enctype'=>'multipart/form-data'  , 'id'=>'edit-admin-form']) !!}
                        <div class="row">
                            @method('PUT')
