...
@section('title', trans('admin.add_country'))
            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    <div class="iq-header-title">
                        <h4 class="card-title"> {{trans('admin.country_info')}}</h4>
                    </div>
                </div>
                <div class="iq-card-body">
                    ...
                    <div class="new-user-info">
                        {!! Form::open(['method' => 'post', 'route' => ['countries.store'], 'enctype' => 'multipart/form-data', 'id' => 'add-country-form']) !!}
                        <div class="row">
                            @method('POST')
