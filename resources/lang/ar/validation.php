...
return [
    ...
    'attributes' => [
        ...
        'experience' => 'الخبرة',
        'preview_extra_price' => 'معاينة السعر الاضافي ',
        'image' => 'الصورة',
        'provider_type' => 'نوع مقدم الخدمة',
        'id_photo' => 'صورة الهوية',
        'profession_license' => 'صورة ترخيص المهنه',
        'university_certificate' => 'صورة الشهادة الجامعية',
        'details.*.name_ar' => 'اسم التفاصيل العربي',
        'details.*.name_en' => 'اسم التفاصيل الانجليزي',
        'property_id' => 'بيانات العقارات',
        'property_image.*' => 'صور بيان العقار',
        'space' => 'المساحة',
        'rate' => 'التقييم',
        'user_id' => 'العميل',
        'building_id' => 'المبني',
        ...
        'area' => 'المنطقة',
        'images' => 'الصور',
        'building_type_id' => 'الوحدة السكنية',
        'residential_unit_number' => 'رقم الوحده السكنية',
        'area_id' => 'اسم المنطقة',
